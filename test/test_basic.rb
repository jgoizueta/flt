...
def exp(mod, x,c=nil)
  ...
  def exp1(mod, x, c=nil)
    return mod::Decimal(BigDecimal("NaN")) if x.infinite? || x.nan?
    y = nil
    ext = 2
...
class TestBasic < Test::Unit::TestCase
  ...
  def test_basic
    $implementations_to_test.each do |mod|
      ...
      mod::Decimal.context.precision = 10
      assert_equal 10, mod::Decimal.context.precision
      assert_equal mod::Decimal("0.3333333333"), mod::Decimal(1)/mod::Decimal(3)
      mod::Decimal.local_context {
        assert_equal 10, mod::Decimal.context.precision
        mod::Decimal.context.precision = 3
        assert_equal 3, mod::Decimal.context.precision
        assert_equal mod::Decimal("0.333"), mod::Decimal(1)/mod::Decimal(3)
      }
      assert_equal 10, mod::Decimal.context.precision
      assert_equal "0.3333333333", (mod::Decimal(1)/mod::Decimal(3)).to_s
      assert_equal mod::Decimal("0.3333333333"), mod::Decimal(1)/mod::Decimal(3)

      mod::Decimal.local_context(:precision=>4) {
        assert_equal 4, mod::Decimal.context.precision
      }
      assert_equal 10, mod::Decimal.context.precision


      assert_equal mod::Decimal("0."+"3"*100), mod::Decimal(1)./(mod::Decimal(3),mod::Decimal.Context(:precision=>100))
      assert_equal 10, mod::Decimal.context.precision
      assert_equal mod::Decimal("0.33"), mod::Decimal(1).divide(mod::Decimal(3),mod::Decimal.Context(:precision=>2))
      assert_equal mod::Decimal("0.3333333333"), mod::Decimal(1)/mod::Decimal(3)

      assert_equal mod::Decimal("11.0"), mod::Decimal(11).abs
      assert_equal mod::Decimal("11.0"), mod::Decimal(-11).abs
      assert_equal mod::Decimal("-11.0"), -mod::Decimal(11)

      assert_equal [-11,0], mod::Decimal("-11").to_int_scale

      unless mod==FPNum::BD
        assert_equal [-110,-1], mod::Decimal("-11.0").to_int_scale
        assert_equal [-11,-1], mod::Decimal("-1.1").to_int_scale
        assert_equal [-110,0], mod::Decimal("-110").to_int_scale
        assert_equal [110,-1], mod::Decimal("11.0").to_int_scale
        assert_equal [11,-1], mod::Decimal("1.1").to_int_scale
        assert_equal [110,0], mod::Decimal("110").to_int_scale
      end

      assert_equal [-11,0], mod::Decimal("-11.0").reduce.to_int_scale
      assert_equal [-11,-1], mod::Decimal("-1.1").reduce.to_int_scale
      assert_equal [-11,1], mod::Decimal("-110").reduce.to_int_scale
      assert_equal [11,0], mod::Decimal("11.0").reduce.to_int_scale
      assert_equal [11,-1], mod::Decimal("1.1").reduce.to_int_scale
      assert_equal [11,1], mod::Decimal("110").reduce.to_int_scale
      ...
      assert_equal mod::Decimal('-0.9'), mod::Decimal('2.1').remainder_near(mod::Decimal('3'))
      assert_equal mod::Decimal('-2'), mod::Decimal('10').remainder_near(mod::Decimal('6'))
      assert_equal mod::Decimal('1'), mod::Decimal('10').remainder_near(mod::Decimal('3'))
      assert_equal mod::Decimal('-1'), mod::Decimal('-10').remainder_near(mod::Decimal('3'))
      assert_equal mod::Decimal('0.2'), mod::Decimal('10.2').remainder_near(mod::Decimal('1'))
      assert_equal mod::Decimal('0.1'), mod::Decimal('10').remainder_near(mod::Decimal('0.3'))
      assert_equal mod::Decimal('-0.3'), mod::Decimal('3.6').remainder_near(mod::Decimal('1.3'))
     ...
     assert_equal mod::Decimal("101"), (+mod::Decimal('101.4'))
     assert_equal mod::Decimal("101"), (+mod::Decimal('100.5'))
     assert_equal mod::Decimal("102"), (+mod::Decimal('101.5'))
     assert_equal mod::Decimal("-101"), (+mod::Decimal('-100.5'))
     assert_equal mod::Decimal("-102"), (+mod::Decimal('-101.5'))
     assert_equal mod::Decimal("-100"), (+mod::Decimal('-100.4'))
     assert_equal mod::Decimal("-101"), (+mod::Decimal('-101.4'))
     mod::Decimal.context.rounding = :half_even
     assert_equal mod::Decimal("100"), (+mod::Decimal('100.5'))
     assert_equal mod::Decimal("101"), (+mod::Decimal('100.51')) unless mod==FPNum::BD
     assert_equal mod::Decimal("101"), (+mod::Decimal('100.6'))
     assert_equal mod::Decimal("102"), (+mod::Decimal('101.5'))
     assert_equal mod::Decimal("101"), (+mod::Decimal('101.4'))
     assert_equal mod::Decimal("-100"), (+mod::Decimal('-100.5'))
     assert_equal mod::Decimal("-102"), (+mod::Decimal('-101.5'))
     assert_equal mod::Decimal("-101"), (+mod::Decimal('-101.4'))
     mod::Decimal.context.rounding = :half_down
     assert_equal mod::Decimal("100"), (+mod::Decimal('100.5'))
     assert_equal mod::Decimal("101"), (+mod::Decimal('101.5'))
     assert_equal mod::Decimal("-100"), (+mod::Decimal('-100.5'))
     assert_equal mod::Decimal("-101"), (+mod::Decimal('-101.5'))
     mod::Decimal.context.rounding = :down
     assert_equal mod::Decimal("100"), (+mod::Decimal('100.9'))
     assert_equal mod::Decimal("101"), (+mod::Decimal('101.9'))
     assert_equal mod::Decimal("-100"), (+mod::Decimal('-100.9'))
     assert_equal mod::Decimal("-101"), (+mod::Decimal('-101.9'))
     mod::Decimal.context.rounding = :up
     assert_equal mod::Decimal("101"), (+mod::Decimal('100.1'))
     assert_equal mod::Decimal("102"), (+mod::Decimal('101.1'))
     assert_equal mod::Decimal("-101"), (+mod::Decimal('-100.1'))
     assert_equal mod::Decimal("-102"), (+mod::Decimal('-101.1'))
     mod::Decimal.context.rounding = :floor
     assert_equal mod::Decimal("100"), (+mod::Decimal('100.9'))
     assert_equal mod::Decimal("101"), (+mod::Decimal('101.9'))
     assert_equal mod::Decimal("-101"), (+mod::Decimal('-100.9'))
     assert_equal mod::Decimal("-102"), (+mod::Decimal('-101.9'))
     mod::Decimal.context.rounding = :ceiling
     assert_equal mod::Decimal("101"), (+mod::Decimal('100.1'))
     assert_equal mod::Decimal("102"), (+mod::Decimal('101.1'))
  ...
  def test_exp
    $implementations_to_test.each do |mod|
      ...
      assert_equal e_100, exp(mod, mod::Decimal(1)).to_s
      assert_equal mod::Decimal(e_100), exp(mod, mod::Decimal(1))
      assert_equal e_100, exp1(mod, mod::Decimal(1)).to_s
  ...
  def test_special
    $implementations_to_test.each do |mod|
      ...
      inf_pos = mod::Decimal(1)/mod::Decimal(0)
      inf_neg = mod::Decimal(-1)/mod::Decimal(0)
